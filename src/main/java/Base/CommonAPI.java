...
//    public String saucelabs_accesskey = "";
    ...
    public void setUp(/*@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,*/
        ...
        System.setProperty("webdriver.chrome.driver", "/Users/tareqhasan/IdeaProjects/ProjectAlibaba/Drivers/chromedriver");
    ...
    public WebDriver getLocalDriver(@Optional("mac") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            ...
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.gecko.driver", "/Users/tareqhasan/IdeaProjects/ProjectAlibaba/Drivers/geckodriver");
            }else if(OS.equalsIgnoreCase("Windows")) {
    ...
    @BeforeMethod
    public void setUp(){
        System.setProperty("webdriver.chrome.driver", "/Users/tareqhasan/IdeaProjects/AmTrustFinancial/src/Drivers/chromedriver");
        driver = new ChromeDriver();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        driver.manage().timeouts().pageLoadTimeout(25, TimeUnit.SECONDS);
        driver.get("https://amtrustfinancial.com");
        driver.manage().window().maximize();
    }*/
    ...
    public void takeScreenshot(String fileName) throws IOException{
        File file = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(file, new File("/Users/tareqhasan/IdeaProjects/ProjectAlibaba/screenShots"+fileName+".png"));
    }
